...
# Anchors matching the heading IDs generated by _append_diagrams() in markdown_writer.py
ANCHOR_CONTEXT_VIEW = "#context-view"
ANCHOR_CONTAINER_VIEW = "#container-view"
